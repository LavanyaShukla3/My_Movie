...
//movie homegae where list of movie present
// has options to search/navigate and create wathclist
...
class _movie_HomepageState extends State<movie_Homepage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: <Widget>[
        // Popular Movies
        buildMovieList(title: "Popular Movies", movieList: popularMoviesList),
        // Upcoming Movies
        buildMovieList(title: "Upcoming Movies", movieList: upcomingMoviesList),
        // Top Rated Movies
        buildMovieList(
        ...
        Container(
          child: Row(
              ...
              children: <Widget>[
                ...
                //SizedBox(width: 80),
                IconButtons(
                    page: "navigationPage", icon: "assistant_navigation"),
                //SizedBox(width: 80),
                IconButtons(page: "listPage", icon: "list"),
                //SizedBox(width: 80),
                IconButtons(
                    page: "userInfoPage", icon: "supervised_user_circle"),
              ]),
        ),
      ],
    ));
